...
<template>
  ...
  -->
  <article class="mx-auto w-[210mm] bg-ground px-[16mm] py-[16mm] font-sans text-[9.5pt] leading-[1.5] text-ink print:w-auto print:p-0">
    <header class="mb-[12mm] grid grid-cols-[34mm_minmax(0,1fr)] items-center gap-x-[9mm]">
      ...
      <div class="border-b-[1pt] border-accent pb-[4mm]">
        <h1 class="text-[20pt] font-semibold leading-[1.1] tracking-[-0.015em]">
          {{ profile.name }}
        </h1>
        <p class="mt-[2.4mm] text-[9.5pt] uppercase tracking-[0.18em] text-muted">
          {{ profile.title }}
        </p>
      </div>
    </header>
    ...
    <div class="mb-[11mm]">
      ...
      <div
        ...
        :key="group.name"
        class="grid grid-cols-[24mm_minmax(0,1fr)] items-baseline gap-x-[4mm] border-b border-rule py-[2.6mm] first:pt-0 last:border-b-0 last:pb-0"
      >
    ...
    <div class="mb-[11mm] grid grid-cols-[24mm_minmax(0,1fr)] items-baseline gap-x-[4mm] gap-y-[3mm]">
      <CvField label="Email">
        {{ profile.email }}
      </CvField>
      <CvField
